# Main Script with Modified Imports
# This file runs the workflow for network meta-analysis and meta-regression with improved package handling
...
library(rstan) # explicit loading to ensure namespace availability
library(doParallel) # for parallel processing

# Ensure proper rstan settings
